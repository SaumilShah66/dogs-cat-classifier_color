...
X, Y  = train_data[:,0:7500],train_data[:,7500:]
X_test, Y_test = test_data[:,0:7500],test_data[:,7500:]
...
model.fit(X_test, Y_test, n_epoch=5, shuffle=True,validation_set=(X_test, Y_test),
